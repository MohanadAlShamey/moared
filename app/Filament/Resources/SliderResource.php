        ...
        return $form
            ->schema([
                Forms\Components\Section::make('')->schema([
                    ...
                    Forms\Components\Textarea::make('caption_ar')->required()->label('الوصف باللغة العربية'),
                    Forms\Components\Textarea::make('caption_en')->required()->label('الوصف باللغة الإنكليزية'),
                    Forms\Components\Textarea::make('caption_tr')->required()->label('الوصف باللغة التركية'),
