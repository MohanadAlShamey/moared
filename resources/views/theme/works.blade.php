...
@foreach($works as $work)
                <div class="col-md-4 pulse animated">
                    <div class="card-news">
                        <div class="card mb-3">
                            <img src="{{$work->img}}" class="card-img-top" alt="{{Str::limit($work->title,10,'...')}}">
                            <div class="card-body">
                                <h5 class="card-title">{{Str::limit($work->title,30,'...')}}</h5>
                                <p class="card-text">
                                    {!! Str::limit($work->info,100,'...') !!}
                                </p>
                                <p class="card-text"><a class="text-muted" href="{{route('theme.works.show',$work)}}">{{lang('read_more')}}
